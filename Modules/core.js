...
const MULT_I18N = {
	en: {
		...
		aq_title: 'Auto Quest',
		aq_desc: 'Automatically claims island quest rewards as soon as they are ready, and always chooses the "Good" path when a Good/Evil choice is available. Checks every 20s.',
		...
		aq_decided_log: '✓ Chose "Good" path for: {name}',
	...
	pt: {
		...
		aq_title: 'Auto Quest',
		aq_desc: 'Reivindica automaticamente as recompensas de missões de ilha assim que ficam prontas, e sempre escolhe o caminho "Bem" quando há escolha entre Bem/Mal. Verifica a cada 20s.',
		...
		aq_decided_log: '✓ Escolhido caminho "Bem" para: {name}',
