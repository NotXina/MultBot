...
__MultBotI18N.dict = {
	en: {
		...
		row_sniper: '🎯 Sniper',
		row_sniper_pending: '{n} snipe(s) pending',
		aa_title: 'Auto Attack',
		aa_desc: 'Attacks automatically when the composition is available. Checks every 20s.',
		aa_origin_label: 'Attacking City',
		aa_rest_label: 'Rest (min)',
		aa_rest_tooltip: 'Wait before re-attacking the same target, ±10% variation. 0 = no wait.',
		...
		aa_unit_label: 'Unit',
		aa_qty_label: 'Qty',
		aa_max_tooltip: 'Always sends ALL available units of this type at the time of attack.',
		aa_add_unit_btn: '+ Unit',
		aa_target_label: 'Target cities (ID, comma or line separated)',
		aa_target_placeholder: 'e.g.: 12345, 67890',
		aa_add_plan_btn: '+ Add Plan',
		aa_plans_active: 'Active plans:',
		aa_no_units_yet: 'No units added yet.',
		aa_no_unit_selected: 'Error: select a unit.',
		aa_invalid_qty: 'Error: enter a valid quantity or check Max.',
		aa_no_origin: 'Error: select an attacking city.',
		aa_no_units: 'Error: add at least one unit.',
		aa_no_targets: 'Error: enter at least one valid target city.',
		aa_plan_updated: 'Plan updated successfully!',
		aa_plan_added: 'Plan added successfully!',
		aa_editing_plan: 'Editing plan from {town} — change and click "Save Changes".',
		aa_edit_cancelled: 'Edit cancelled.',
		aa_attack_ok: 'OK: {origin} attacked {target} [{comp}]',
		aa_attack_fail: 'FAILED to attack {target}: {msg}',
		...
		ah_silver_desc: 'Silver mode: when silver reaches 90% of warehouse, stores 10% in the hideout automatically.',
		ah_silver_trigger_log: '⚡ {town}: silver at {pct}% ({iron}) — storing {amount} in hideout.',
		sniper_title: '🎯 Sniper',
	...
	pt: {
		...
		row_sniper: '🎯 Sniper',
		row_sniper_pending: '{n} snipe(s) agendado(s)',
		aa_title: 'Auto Ataque',
		aa_desc: 'Ataca automaticamente quando a composição estiver disponível. Verifica a cada 20s.',
		aa_origin_label: 'Cidade Atacante',
		aa_rest_label: 'Descanso (min)',
		aa_rest_tooltip: 'Espera antes de reatacar o mesmo alvo, ±10% de variação. 0 = sem espera.',
		aa_hero_label: 'Herói (opcional)',
		aa_hero_tooltip: 'Opcional. Envia esse herói junto com o ataque, se disponível na cidade atacante no momento do disparo.',
		...
		aa_target_placeholder: 'ex: 12345, 67890',
		aa_add_plan_btn: '+ Adicionar Plano',
		aa_plans_active: 'Planos ativos:',
		aa_no_units_yet: 'Nenhuma unidade adicionada ainda.',
		aa_no_unit_selected: 'Erro: selecione uma unidade.',
		aa_invalid_qty: 'Erro: informe uma quantidade válida ou marque Max.',
		aa_no_origin: 'Erro: selecione uma cidade atacante.',
		aa_no_units: 'Erro: adicione ao menos uma unidade.',
		aa_no_targets: 'Erro: informe pelo menos uma cidade-alvo válida.',
		aa_plan_updated: 'Plano atualizado com sucesso!',
		aa_plan_added: 'Plano adicionado com sucesso!',
		aa_editing_plan: 'Editando plano de {town} — altere e clique em "Salvar Alterações".',
		aa_edit_cancelled: 'Edição cancelada.',
		aa_attack_ok: 'OK: {origin} atacou {target} [{comp}]',
		aa_attack_fail: 'FALHA ao atacar {target}: {msg}',
		...
		ah_silver_desc: 'Modo prata: quando a prata chegar a 90% do armazém, guarda 10% no esconderijo automaticamente.',
		ah_silver_trigger_log: '⚡ {town}: prata em {pct}% ({iron}) — guardando {amount} no esconderijo.',
		sniper_title: '🎯 Sniper',
