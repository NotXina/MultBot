...
__MultBotI18N.dict = {
	en: {
		...
		asp_happiness_desc: 'Casts Divine Sign (Happiness) on the target city every 3 hours. Requires Zeus favor.',
		...
		asp_started_log: 'Started. Target: {name} | Earthquake: 1h | Happiness: 3h',
	...
	pt: {
		...
		asp_happiness_desc: 'Lança Sinal Divino (Felicidade) na cidade alvo a cada 3 horas. Requer favor de Zeus.',
		...
		asp_started_log: 'Iniciado. Alvo: {name} | Terremoto: 1h | Felicidade: 3h',
